package com.smartnote.smartnotebackend.usermanagement.config.jwt;
...
public class JwtUtils {
    ...
    @Value("${smartnote.app.jwtSecret}")
    private String jwtSecret;

    @Value("${smartnote.app.jwtExpirationMs}")
    private int jwtExpirationMs;

    @Value("${smartnote.app.jwtCookieName}")
